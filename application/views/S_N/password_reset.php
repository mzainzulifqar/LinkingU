	...
	<div class="limiter">
		<div class="container-login100" style="background-image: url('<?php echo base_url();?>theme/login_page/images/bg-01.jpg');">
			...
			<div class="wrap-login100 p-l-55 p-r-55 p-t-65 p-b-54">
				...
				<form class="login100-form validate-form" method="post" action="<?php echo base_url();?>main/password_reset_verify">
				...
				if(!empty($result))
					...
					<div class="wrap-input100 validate-input m-b-23" data-validate="Password is required">
						<span class="label-input100">Password Reset Code</span>
						<input class="input100" type="password" name="password_reset_code" placeholder="Type your Code">
						<span class="focus-input100" data-symbol="&#xf190;"></span>
